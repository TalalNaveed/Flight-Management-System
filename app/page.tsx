...
import FlightSearchPage from '../src/pages/public/FlightSearchPage'

// Customer pages
import CustomerDashboard from '../src/pages/customer/CustomerDashboard'
import MyFlightsPage from '../src/pages/customer/MyFlightsPage'
import PurchasePage from '../src/pages/customer/PurchasePage'
import RatingsPage from '../src/pages/customer/RatingsPage'

// Staff pages
import StaffDashboard from '../src/pages/staff/StaffDashboard'
import ViewFlightsPage from '../src/pages/staff/ViewFlightsPage'
import CreateFlightPage from '../src/pages/staff/CreateFlightPage'
import AirplanesPage from '../src/pages/staff/AirplanesPage'
import ReportsPage from '../src/pages/staff/ReportsPage'
